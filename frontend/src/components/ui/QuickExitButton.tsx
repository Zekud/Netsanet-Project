...
export default function QuickExitButton() {
  ...
  return (
    <button
      onClick={handleExit}
      className="fixed bottom-6 right-4 md:bottom-8 md:right-8 z-50 flex items-center gap-1.5 bg-exit-red hover:bg-danger text-white text-sm font-semibold px-4 py-2 rounded-full transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-1 active:scale-95"
